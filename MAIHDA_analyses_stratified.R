...
model1_race_edu_f1_tree_total_low <- brm(tree_total~1+age1c+gender1+income1+site1c+(1|strata),
...
model1_race_edu_f1_tree_total_high <- brm(tree_total~1+age1c+gender1+income1+site1c+(1|strata),
